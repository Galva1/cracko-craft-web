          ...
          <div className="w-full h-full bg-ngray-400/50 p-8" >
            <div className="text-center relative max-w-6xl mx-auto mt-auto">
              <h1 className="text-6xl md:text-8xl font-black  mb-6 tracking-tight leading-tight ">
                <span className="flex text-(--color-content) transform duration-300 text-shadow-lg/30 ">Bem vindo ao CrackoCraft</span>   
                </h1>
                <section className="mt-15 flex gap-4 justify-center">
                  <button className="px-5 py-2 text-base font-bold text-(--color-content) bg-(--color-accent) hover:bg-(--color-tertiary) rounded border-none cursor-pointer transform duration-300 hover:scale-110 ">Baixar Modpack</button>
                  <button className="px-5 py-2 text-base font-bold text-(--color-content) bg-(--color-accent) hover:bg-(--color-tertiary) rounded border-none cursor-pointer transform duration-300 hover:scale-110">Copiar IP</button>
                </section>
            </div>
          </div>
